...
LOGIN_REDIRECT_URL='/afterlogin' # redirect user to find the correct page
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'nduduzompumelelokhanyile@gmail.com' # this email will be used to send emails
